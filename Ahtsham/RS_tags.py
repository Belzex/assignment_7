...
def offline_initialization(moviesdata, tagsdata):
...
def get_similar_movies_based_on_content(input_movie_title) :
    cosine_sim, movie_content_df_temp =read_model_content_data()
...
if __name__ == '__main__':
    #offline_initialization('movies.csv','tags.csv')
    input_movie = 'Red (2010)'
